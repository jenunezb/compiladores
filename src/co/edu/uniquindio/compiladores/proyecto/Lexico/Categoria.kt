...
enum class Categoria {
    ...
    PALABRA_RESERVADA_FUNCION_MATEMATICA,PALABRA_IDENTIFICADOR_MATEMATICO,PALABRA_RESERVADA_ROMPER,PALABRA_RESERVADA_CONTINUAR,FIN_CODIGO,LLAVECIERRE,LLAVEAPERTURA,PARENTESISABIERTO,PARENTESISCERRADO,
    CONCATENAR
}